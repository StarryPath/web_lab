...
<form method="post" action="xss_basic_01.php">
...
if(isset($_POST["submit"]) && $_POST["submit"] == "提交")
{
	...
	else
	{
		...
		$sql = "insert into xss1(username,sub,content) values(?,?,?)";
...
$sql2="select * from xss1 order by id desc limit 0,10";
