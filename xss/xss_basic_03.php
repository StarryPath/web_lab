...
<form method="post" action="xss_basic_03.php">
...
if(isset($_POST["submit"]) && $_POST["submit"] == "提交")
{
	...
	else
	{
		...
		$sql = "insert into xss3(username,sub,content) values(?,?,?)";
...
$sql2="select * from xss3 order by id desc limit 0,10";
